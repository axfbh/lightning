...
def parse_opt():
    ...
    # parser.add_argument("--cfg", type=str, default="./models/yolov4.yaml", help="models.yaml path")
    parser.add_argument("--cfg", type=str, default="../cfg/voc-seg.yaml", help="dataset.yaml path")
    parser.add_argument("--hyp", type=str, default="../cfg/hyp/hyp-unet-low.yaml", help="hyperparameters path")
